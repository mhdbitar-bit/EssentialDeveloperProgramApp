...
//    private lazy var scheduler = DispatchQueue(label: "com.essentialdeveloper.infa.queue", qos: .userInitiated) Serial thread
//    private lazy var scheduler = DispatchQueue(label: "com.essentialdeveloper.infa.queue", qos: .userInitiated, attributes: .concurrent) concurrent thread
